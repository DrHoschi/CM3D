...
const sketchMutationContract=installSketchMutationContract(store); const genericSketchElementMutationContract=installGenericSketchElementMutationContract(store); const genericEndpointConnectivityContract=installGenericEndpointConnectivityContract(store); const sketchCircleIntegration=installSketchCircleIntegration(store,runtime,appUI); const sketchMultiSelection=installSketchMultiSelection(store,runtime,appUI);
